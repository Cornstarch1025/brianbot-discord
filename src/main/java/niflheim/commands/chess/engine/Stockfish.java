...
public class Stockfish {
    ...
    public String getOutput(int waitTime, int bestmove) {
        ...
        try {
            ...
            while (true) {
                ...
                if (text.equals("readyok") && bestmove == 0)
                    break;
                else if (bestmove == 1 && text.contains("bestmove")) {
                    buffer.append(text + "\n");
                    break;
                } else
                    buffer.append(text + "\n");
    ...
    public String getBestMove(String fen, int waitTime) {
        ...
        return getOutput(waitTime + 20, 1).split("bestmove ")[1].split(" ")[0];
    }
    ...
    public void drawBoard(String fen) {
        ...
        String[] rows = getOutput(0, 0).split("\n");
    ...
    public float getEvalScore(String fen, int waitTime) {
        ...
        String[] dump = getOutput(waitTime + 20, 1).split("\n");
